...
* **Agentic AI patterns -**
  ...
  - Also covers following topics:
    - Agent patterns -
      - Agent patterns are reusable design templates that describe the structure and behavior of individual agents. E.g., RAG agents, coding agents etc.
    - LLM workflows -
      - Workflows focus on how agents use LLMs for reasoning
